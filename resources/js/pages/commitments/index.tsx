...
export default function CommitmentsIndex() {
    const { commitments = [] } = usePage<{ commitments: CommitmentSummary[] }>()
        .props;
    ...
    const describeCadence = (commitment: CommitmentSummary) => {
        ...
        const baseLabel =
            recurrenceOptions.find(
                (option) => option.value === commitment.recurrence_type,
            )?.label ?? commitment.recurrence_type;
                ...
                <CardContent className="p-0">
                    {commitments.length === 0 ? (
                        <div className="flex flex-col items-center gap-3 px-6 py-12 text-center">
                            <p className="text-sm text-muted-foreground">
                                No commitments yet. Add your mortgage, rent,
                                utilities, or subscriptions so future pay cycles
                                can pre-fill them.
                            </p>
                            <Button
                                onClick={openCreate}
            ...
            >
                <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Define the recurring outflow you want every cycle to
                            honor.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) =>
                                        form.setData('recurrence_type', value)
                                    }
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                            ...
                            <div className="space-y-1.5">
                                ...
                                />
                                <InputError
                                    message={form.errors.first_due_date}
                                />
                            </div>
                            <div className="space-y-1.5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                id="form-notes"
                                className="min-h-[70px] w-full rounded-lg border border-input bg-background px-3 py-2 text-sm focus:ring-2 focus:ring-primary/40 focus:outline-none"
