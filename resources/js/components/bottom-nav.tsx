...
export function BottomNav() {
    ...
    return (
        <nav
            aria-label="Primary"
            className="fixed inset-x-0 bottom-0 z-50 border-t border-sidebar-border/70 bg-background/95 backdrop-blur-sm pb-[env(safe-area-inset-bottom)] md:hidden dark:border-sidebar-border"
        >
